...
version = pyaxisvm.__version__
# The full version, including alpha/beta/rc tags.
release = pyaxisvm.__version__ + '-git'
...
latex_documents = [
    ('index', 'pyaxisvm.tex', u'PyAxisVM Documentation',
     u'Inter-CAD Kft.', 'manual'),
]
...
man_pages = [
    ('index', 'pyaxisvm', u'PyAxisVM Documentation',
     [u'Inter-CAD Kft.'], 1)
]
...
texinfo_documents = [
    ('index', 'pyaxisvm', u'PyAxisVM Documentation',
     u'Bence Balogh', 'pyaxisvm', 'One line description of project.',
     'Miscellaneous'),
]
