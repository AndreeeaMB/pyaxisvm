...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": f"https://github.com/AxisVM/pyaxisvm",
            "icon": "fab fa-github",
            "type": "fontawesome",
        },
        {
...
.. raw:: html
    ...
    <div class="admonition note">
      ...
      <a class="reference external" href="https://github.com/AxisVM/pyaxisvm/blob/{{ env.config.release|e }}/{{ docname|e }}">{{ docname|e }}</a>.
    </div>
